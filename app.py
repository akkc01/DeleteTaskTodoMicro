...
# connection_string = "Driver={ODBC Driver 18 for SQL Server};Server=tcp:akkddc-sql.database.windows.net,1433;Database=akddfkcdb;Uid=dakfdkc;Pwd=Defvo0psg@1752837475;Encrypt=yes;TrustServerCertificate=no;Connection Timeout=30;"
